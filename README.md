...
## 🛠️ Core Competencies
* **Technical Proficiencies:** Python, HTML, CSS, JavaScript
* **Design & Strategy:** UI/UX principles, Project Management, Agile methodologies
* **Problem Solving:** Data Structures & Algorithms, DataBase Management System. 
...
* **sudoku solver:** An algorithmic calculation engine built to solve complex Sudoku puzzles
* **Rock paper Scissors Enginer:** An interactive computational program modeling game rules through structured conditional architecture.
* **DevMatch: Project Blueprint Generator** A minimalist, single-page web application designed to eliminate decision paralysis for software engineering students and self-taught developers.

## 📬 Contact & Links
* **LinkedIn:** https://www.linkedin.com/in/mariam-farheen-saif-747701337/
* **Email:** farheenmariam3@gmail.com
* **GitHub:** https://github.com/farheenmariam3-dotcom
